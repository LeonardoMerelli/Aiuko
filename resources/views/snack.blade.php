...
<div class="snack-div">
  ...
  <div class="select-div">
    ...
    <div class="select-item-no selected" onclick="closePopup()">
    @else
  ...
  <form action="{{route('snack.store')}}" method="post">
    ...
    @if($preferenzeSnack != null) 
      <textarea name="preferenzeSnack" id="preferenzeSnack">{{$preferenzeSnack[0]['snackPreferiti']}}</textarea>
    @else
      <textarea name="preferenzeSnack" id="preferenzeSnack"></textarea>
    @endif
    ...
    <div class="bottoni">
      <a href="{{route('durata.create')}}">INDIETRO</a>
